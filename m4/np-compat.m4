AC_DEFUN([AC_FLWKEY_NP_COMPAT], [
  ...
  AC_FLWKEY_SEARCH_LIBS([dlopen], [dl], [$other_libs])
  AC_FLWKEY_SEARCH_LIBS([clock_gettime], [rt], [$other_libs])
  AC_FLWKEY_SEARCH_LIBS([sem_unlink], [$sem_libs], [$other_libs])
  AC_FLWKEY_SEARCH_LIBS([sem_timedwait], [$sem_libs], [$other_libs])
